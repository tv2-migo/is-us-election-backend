...
>
    ...
    <xsl:template name="processResourceDetail">
        ...
        <li class="resource slideContainer">
            ...
            <div class="methods swadl-slider">
                <p>
                    <xsl:call-template name="getDoc">
                        <xsl:with-param name="base" select="$resourceBase"/>
                    </xsl:call-template>
                                ...
                                <ul class="operations">
                                    <li class="{$name} operation">
                                        <div class="heading" onclick="slideToggle(this,'contentContainer');">
                                            ...
                                            <xsl:variable name="id2-1">
                                                <xsl:value-of select="@name"/>
                                            </xsl:variable>
                                            <h3>
                                                <span class="http_method {$id2-1}">
                                                    <a name="{$id2}">
                                                        <xsl:value-of select="@name"/>
                                                    </a>
                                                </span>
                                                <span class="path">
                                                    <a>
                                                        <xsl:if test="contains($subPath, '{ext')">
                                                            <xsl:value-of select="substring-before($subPath, '{ext')"/>
                                                        </xsl:if>
                                                        <xsl:if test="not(contains($subPath, '{ext'))">
                                        ...
                                        <div class="contentContainer swadl-slider">
                                            <div class="content">
                                                <p>
                                                    <xsl:call-template name="getDoc">
                                                        <xsl:with-param name="base" select="$resourceBase"/>
                                                ...
                                                <xsl:if test="contains($subPath, '{ext')">
                                                    <a target="_blank" href="{translate(translate(substring-before($fullPath, '{ext'), '{', ''), '}', '')}">
                                                        <xsl:value-of select="substring-before($fullPath, '{ext')"/>
                                                    </a>
                                                 </xsl:if>
                                                <xsl:if test="not(contains($subPath, '{ext'))">
                                                    <a target="_blank" href="{$fullPath}"><xsl:value-of select="$fullPath"/></a>
                                                </xsl:if>
